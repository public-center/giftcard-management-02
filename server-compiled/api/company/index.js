...
router.get('/:companyId/store/:storeId/inventory', auth.hasRole('employee'), controller.getCardsInInventory);
...
router.get('/:companyId/store/:storeId/reconciliationCompleteTime', auth.hasRole('employee'), controller.reconciliationCompleteTime);
